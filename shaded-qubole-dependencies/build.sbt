...
name := "spark-hiveacid-shaded-qubole-dependencies"
...
// For the qubole libraries in jfrog
resolvers += "my-maven-proxy-releases" at "https://qubole.jfrog.io/qubole/libs-release/"
resolvers += "my-maven-proxy-releases-snapshot" at "https://qubole.jfrog.io/qubole/libs-snapshot/"
updateOptions := updateOptions.value.withLatestSnapshots(false)

// Pick credentials from credentials file
credentials += Credentials(Path.userHome / ".ivy2" / "credentials")

libraryDependencies ++= Seq(
  // Hive/Orc core dependencies packed.
  "org.apache.hive" % "hive-metastore" % "3.1.1-qds-1.0.2-SNAPSHOT" intransitive(),
  "org.apache.hive" % "hive-exec" % "3.1.1-qds-1.0.2-SNAPSHOT" intransitive(),
  "org.apache.orc" % "orc-core" % "1.5.1-qds-2.0-SNAPSHOT" intransitive(),
  "org.apache.orc" % "orc-mapreduce" % "1.5.1-qds-2.0-SNAPSHOT" intransitive(),

  // Only for hive3 client in tests.. but packing it in shaded jars.
  "org.apache.hive" % "hive-jdbc" % "3.1.1-qds-1.0.2-SNAPSHOT" intransitive(),
  "org.apache.hive" % "hive-service" % "3.1.1-qds-1.0.2-SNAPSHOT" intransitive(),
  "org.apache.hive" % "hive-serde" % "3.1.1-qds-1.0.2-SNAPSHOT" intransitive(),
  "org.apache.hive" % "hive-common" % "3.1.1-qds-1.0.2-SNAPSHOT" intransitive(),
)
